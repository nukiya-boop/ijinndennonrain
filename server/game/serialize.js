...
function expandCard(instance, ps) {
  ...
  return {
    ...
    equippedCards: (instance.equippedCards || []).map((eq) => ({ uid: eq.uid, name: cardsMod.getCard(eq.cardId).name })),
    equippedCardName: instance.equippedCards && instance.equippedCards[0] ? cardsMod.getCard(instance.equippedCards[0].cardId).name : null,
    equippedCardUid: instance.equippedCards && instance.equippedCards[0] ? instance.equippedCards[0].uid : null,
